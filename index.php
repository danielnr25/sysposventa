            ...
            <div class="card-box">
                ...
                <div class="form-horizontal m-t-20">
                    ...
                    <div class="form-group text-right m-t-20">
                        <div class="col-xs-12">
                            <button id="btn-login" class="btn btn-primary btn-custom w-md waves-effect waves-light" type="button" onclick="signup()">Ingresar
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="form-group m-t-30">
                        <div class="col-sm-7">
                            <a href="pages-recoverpw.html" class="text-muted"><i class="fa fa-lock m-r-5"></i> ¿Olvidó su contraseña?</a>
                        </div>
